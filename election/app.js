  ...
  try {
    ...
    if (data.status === 'ok') {
      ...
      grid.innerHTML = items.map(item => {
        ...
        return `
          <div class="news-card">
            <img src="${imgUrl}" alt="News Image" class="news-img" onerror="this.src='assets/parliament_hero.png'">
...
function initRegionalHub() {
  ...
  getInfoBtn.addEventListener('click', () => {
    ...
    if (state && district && taluka) {
      ...
      document.getElementById('regional-booth-text').textContent = boothText.replace('{taluka}', taluka);
